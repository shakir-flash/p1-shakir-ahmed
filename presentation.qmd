...
format:
  revealjs:
    ...
    footer: "[🔗ThePlottingPandas](https://info526-dataviz.github.io/project-01-The-Plotting-Pandas/)"
    smaller: true
    scrollable: true
...
## Outcome of the Approach {auto-animate="true"}

::: columns
::: {.column width="20%"}
-   Forest conversion across the world in `2000` decade
:::

::: {.column width="80%"}
```{r plot_2000, warning=FALSE, fig.width=8}
plot_2000
```
:::
:::
...
```{r q2plot_forest_anim, message=FALSE, echo=TRUE}
#| code-fold: true
...
```{r q2plot_brazil_anim, message=FALSE, echo=TRUE}
#| code-fold: true
#| code-summary: "Animation of forest coverage"
...
-   The visualizations provide a clear depiction of the steady increase in soybean consumption in Brazil. The data shows a remarkable increase, from approximately 16.4 million pounds of soybeans in 1990 to a staggering 36.87 million pounds in 2013. This indicates a substantial growth over this period.

-   The forest coverage in Brazil dropped from 588 million hectares in 1990 to 507 million hectares in 2013, representing a significant loss of 81 million hectares of forest land during this time. This reduction in forest area is indicative of the environmental impact in Brazil.
...
## I am Groot!? {auto-animate="true"}

::: columns
::: {.column width="50%"}
[Thank You!]{style="font-size: 32px; color: #546747; font-weight: bold;text-align: center;"}

![](images/presentation/groot_hi.gif){fig-align="center" width="300"}
:::

::: {.column width="50%"}
[Any Questions?]{style="font-size: 32px; color: #546747; font-weight: bold;text-align: center;"}

![](images/presentation/groot_focused.gif){fig-align="center" width="400"}
:::
:::
